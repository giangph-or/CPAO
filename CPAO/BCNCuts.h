...
public:
    ...
    GRBVar* theta;
    CB();
    CB(GRBVar* x, GRBVar* y, GRBVar* z, GRBVar* theta, int products, int customers, int cuts, vector<double> noPay, vector<vector<double>> util, vector<vector<double>> ren, vector<vector<int>> group);
protected:
    void callback();
