...
BCNCuts::BCNCuts(Data data, double time_limit, string outfile) {
	this->data = data;
...
vector<double> BCNCuts::calculate_y(Data data, vector<int> x, vector<double> alpha) {
...
vector<double> BCNCuts::calculate_z(Data data, vector<int> x) {
...
double  BCNCuts::calculate_original_obj(Data data, vector<int> x, vector<double> alpha) {
	double obj = 0;
	for (int i = 0; i < data.number_customers; ++i) {
...
double BCNCuts::calculate_master_obj(Data data, vector<int> x) {
	double obj = 0;
	for (int i = 0; i < data.number_customers; ++i) {
...
double BCNCuts::calculate_original_obj_tmp(Data data, vector<int> x, vector<double> alpha, int candidate) {
	double obj = 0;
	for (int i = 0; i < data.number_customers; ++i) {
...
vector<int> BCNCuts::greedy(Data data, int budget, vector<double> alpha) {
...
double BCNCuts::calculate_bound_y(Data data, int budget, int i, double alpha) {
	double sum = 0;
...
double BCNCuts::calculate_bound_z(Data data, int budget, int i) {
	double sum = 0;
	vector<double> u(data.number_products);
	for (int j = 0; j < data.number_products; ++j)
...
double BCNCuts::calculate_optimal_bound_y(Data data, int budget, int i, double alpha) {
...
void BCNCuts::solve_build_in(Data data, int budget, int nCuts) {
